...
//     return (
//       <div className="top-performer-container smaller-profile">
//         <h1>Top Performer of the Month</h1>
//         <div className="top-performer-details">
//           {topPerformer && (
//             <>
//               <div className="profile-image top-performer-image">
//                 <img src="" alt="Top Performer" />
//               </div>
//               <h2>{topPerformer.name}</h2>
//               <p>Email: {topPerformer.email}</p>
//               <p>Role: {getRoleName(topPerformer.role)}</p>
//               <p>Pincode: {topPerformer.pincode}</p>
//               <p>
//                 Number of Children assigned: {topPerformer.children.filter(Boolean).length}
//               </p>
//               {/* Additional details of the top performer */}
//             </>
//           )}
//         </div>
//       </div>
